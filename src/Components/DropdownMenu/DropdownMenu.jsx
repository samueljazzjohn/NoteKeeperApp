...
const DropdownMenu = (props) => {
    ...
    return (
        <>
            {props.DropdownStatus && <div ref={props.refvar} id="dropdown" className="z-99 absolute top-3 md:top-8 right-8 translate-y-10 bg-white divide-y divide-gray-100 rounded-lg  w-44 border border-gray-500 shadow-lg">
